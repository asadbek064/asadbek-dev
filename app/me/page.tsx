            ...
            <div
                ...
                <div className='relative my-12'>
                    ...
                    <div className={'aspect-[16/9] w-full'}>
                        <iframe className={'overflow-hidden min-h-full'} src="https://mylinx-player.pages.dev?provider=YOUTUBE&amp;id=3IDwtt090cY&amp;autoplay=true&amp;mute=true" allowFullScreen  width="100%" allow="autoplay" picture-in-picture="true" clipboard-write="true" loading="lazy" encrypted-media="true"></iframe>
                    </div>
                </div>
                <p className="mb-8">
