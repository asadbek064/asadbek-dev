...
Create a `.env` file similar to [`.env.example`](https://github.com/leerob/asadbek.dev/blob/main/.env.example).

## Cloning / Forking

Please review the [license](https://github.com/leerob/asadbek.dev/blob/main/LICENSE.txt) and remove all of my personal information (resume, blog posts, images, etc.) by running `pnpm run setup`.
