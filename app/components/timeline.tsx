...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div>
      ...
      <div
      className="w-full bg-white dark:bg-neutral-950 font-sans rounded-md"
      ref={containerRef}
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 md:px-8">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-[28%] md:w-full">
